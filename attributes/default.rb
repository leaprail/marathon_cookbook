...
# Marathon package
default['marathon']['version']            = '1.6.322-2bf46b341'
default['marathon']['source']['url']      =
  "https://downloads.mesosphere.com/marathon/releases/#{node['marathon']['version'].split('-').first}/marathon-#{node['marathon']['version']}.tgz"
